    ...
    <div class="wrp">
        <div class="left">
            <div class="item">
                ...
                <a href="tel:0343754517" title="Hotline" class="tel">
                <span class="icon"><i class="fas fa-phone"></i></span>
                <span class="text">034.375.4517</span>
                </a>
            </div>
            <div class="item">
    ...
    <div class="wrp">
        <div class="top">
            <div class="left">
                ...
                <div class="cont fs16">
                    <b>CÔNG TY CỔ PHẦN TRỰC TUYẾN Hải Anh.</b>
                </div>
                <ul style="display: block;">
                    <li>
                        <span class="icon"><i class="fas fa-map-marker-alt"></i></span>
                        <span class="text">VPGD: Số 55 Nam Kỳ Khởi Nghĩa, Bình Thạnh, TP Hồ Chí Minh.</span>
                    </li>
                    <li>
                        <span class="icon"><i class="fas fa-phone-volume"></i></span>
                        <a href="tel:0367530598" title="Hotline" class="text">Hotline: 034.375.4517</a>
                    </li>
                    <li>
                        <span class="icon"><i class="fas fa-envelope"></i></span>
                        <a href="mailto:laravel1998bn@gmail.com" title="email" class="text">nguyenkhanhtv@gmail.com</a>
                    </li>
                </ul>
            </div>
            <div class="mid">
        ...
        <div class="bot">
            <p class="fRobotoB pb5 fs16">Thành Trung Watch</p>
            <h4 class="lh21">
...
<div id="commonBot">
    <div class="wrp">
        <div class="left">
            Copyright © 2023 Thành Trung Watch.
        </div>
        <ul class="right">
            <li>
