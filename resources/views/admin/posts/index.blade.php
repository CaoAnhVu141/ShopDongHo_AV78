            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="{{ route('showaddpost') }}" class="btn btn-primary">Thêm mới </a>
                        </h3>
                                ...
                                @if(isset($posts))
                                    @foreach ($posts as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->categorypost->name }}</td>
                                            <td><img src="{{ url($item->image) }}" alt="" height="80px"></td>
                                            <td>{{ $item->created_at }}</td>
                                            <td>
                                                <a href="{{ route('showindexupdatepost',['id'=> $item->id_post]) }}"
