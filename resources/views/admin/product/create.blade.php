            ...
            <form action="{{ route('addproduct') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_category" class="form-control js-check-type" data-url="">
                                    @if (isset($category))
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_typeproduct" class="form-control js-type-product">
                                    @if (isset($producttype))
                                        @foreach ($producttype as $item)
                                            <option value="{{ $item->id_typeproduct }}">{{ $item->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="id_trademark" class="form-control js-type-product">
                                    @if (isset($trademark))
                                    ...
                                    @foreach ($attributes as $item)
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="radio" name="id_attribute"
                ...
                <div class="col-md-12">
                    <div class="box-footer" style="text-align: center;">
                        <a href="{{ route('showproducts') }}" class="btn btn-danger"><i class="fa fa-undo"></i> Trở
                            Lại</a>
