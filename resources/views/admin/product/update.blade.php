                        ...
                        <div class="box-header with-border">
                          ...
                          <div class="box-body">
                            <div class="form-group {{ $errors->first('pro_name') ? 'has-error' : '' }}">
                              ...
                              <input type="text" name="pro_name" class="form-control" value="{{ $products->name }}"  placeholder="Name ....">
                            ...
                            <div class="form-group col-sm-6 {{ $errors->first('pro_price') ? 'has-error' : '' }}" >
                                ...
                                <div class="input-group ">
                                    <span class="input-group-addon">$</span>
                                        <input type="number" name="pro_price" value="{{ $products->price }}" class="form-control">
                            ...
                            <div class="form-group" {{ $errors->first('pro_sale') ? 'has-error' : '' }}>
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon">$</span>
                                        <input type="number" value="{{ $products->discount }}" name="pro_sale" class="form-control">
                            ...
                            <div>
                              ...
                              <div class="form-group {{ $errors->first('pro_description') ? 'has-error' : '' }}">
                                ...
                                <textarea class="form-control" value="" name="pro_description" rows="3" placeholder="Enter ...">{{ $products->description }}</textarea>
                      ...
                      <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="form-group {{ $errors->first('pro_content') ? 'has-error' : '' }}">
                                ...
                                <textarea class="form-control" value="" name="pro_content" rows="3" placeholder="Enter ...">{{ $products->content }}</textarea>
