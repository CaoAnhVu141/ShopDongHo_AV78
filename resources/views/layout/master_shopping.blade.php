...
<head>
    ...
    <script>
        ...
        (function() {
            function asyncLoad() {
                var urls = ["{{ asset('admin/shopping/hstatic.net/652/1000177652/20/2017/4-10/noname.js') }}"];
    ...
    <!-- Include jQuery -->
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/js/jquery.min.1.11.0.js') }}"></script>
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/option_selection.js') }}"></script>
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/js/jquery.min.1.11.0.js') }}"
        type="text/javascript"></script>
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/api.jquery.js') }}" type="text/javascript"></script>
    <script src="{{ asset('admin/shopping/theme.hstatic.net/1000177652/1000229231/14/default_script.min.js?v=90') }}"
        type="text/javascript"></script>
    <link href="{{ asset('admin/shopping/theme.hstatic.net/1000177652/1000229231/14/default_style.min.css?v=90') }}"
        rel="stylesheet" type="text/css" media="all">
    <!--[if lt IE 9]>
<script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/theme-default/html5shiv.js') }}"></script>
<![endif]-->
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/theme-default/jquery-migrate-1.2.0.min.js') }}">
    </script>
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/theme-default/jquery.touchSwipe.min.js') }}"
        type="text/javascript"></script>
    <script data-target=".product-resize" data-parent=".products-resize" data-img-box=".image-resize"
        src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/js/fixheightproductv2.js') }}"></script>
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/js/haravan.plugin.1.0.js') }}"></script>
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/theme-default/jquery.flexslider.js') }}"
        type="text/javascript"></script>
    <script src="{{ asset('admin/shopping/hstatic.net/0/0/global/design/theme-default/jquery-migrate-1.2.0.min.js') }}">
    </script>
    <link href="{{ asset('admin/shopping/hstatic.net/0/0/global/design/theme-default/flexslider.css') }}"
        rel="stylesheet" type="text/css" media="all" />
    <script src="{{ asset('admin/shopping/theme.hstatic.net/1000177652/1000229231/14/scripts.js?v=90') }}"
        type="text/javascript"></script>
    <link rel="stylesheet" type="text/css"
        href="{{ asset('admin/shopping/hstatic.net/0/0/global/design/member/fonts-master/roboto.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('admin/shopping/hstatic.net/0/0/global/design/css/bootstrap.3.3.1.css') }}">
    <!-- Latest compiled and minified JavaScript -->
    <link
        href="{{ asset('admin/shopping/hstatic.net/0/0/global/design/plugins/font-awesome/4.6.3/css/font-awesome.min.css') }}"
        rel="stylesheet" type="text/css" media="all" />
    <link href="{{ asset('admin/shopping/theme.hstatic.net/1000177652/1000229231/14/styles.css?v=90') }}"
        rel="stylesheet" type="text/css" media="all" />
</head>
</style>
    ...
    <div id="page">
                                    ...
                                    <div class="owl-wrapper" style="width: 600px; left: 0px; display: block;">
                                        ...
                                        <div class="owl-item" style="width: 100px;">
                                            <li class="product-thumb"><a href="javascript:void(0);"
                                                    ...
                                                    <img
                                                        src="{{ asset('admin/shopping/product.hstatic.net/1000177652/product/3_30be00d496bb474aa0e9324311dd02f0_small.jpg') }}"></a>
                                            </li>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <form id="form-quickview" method="post" action="/cart/add">
                        <div class="quickview-information">
                            ...
                            <div class="form-input ">
                                <label>
                                    Số lượng</label>
                                <input id="quantity-quickview" name="quantity" type="number" min="1"
                                    value="1">
                            </div>
                            <div class="form-input" style="width: 100%">
                                ...
                                <div class="qv-readmore">
                                    <span>hoặc </span><a class="read-more p-url" href="" role="button">Xem
                                        chi tiết</a>
                                </div>
                            </div>
                        </div>
                ...
                var callBack = function(variant, selector) {
                    if (variant) {
                        ...
                        if (variant != null && variant.featured_image != null) {
                            item.find(".product-thumb a[data-image='" + Haravan.resizeImage(variant.featured_image
                                .src, 'large') + "']").click();
                        }
                ...
                var quickViewProduct = function(purl) {
                    ...
                    $.ajax({
                        ...
                        success: function(product) {
                            ...
                            item.find('.quickview-title').attr('title', product.title).attr('href',
                                product.url).find('h4').html(product.title);
                            item.find('.quickview-variants').html(quickview_html_variants);
                            $('.quickview-image').html(quickview_image_zoom);
                            $.each(product.variants, function(i, v) {
                                item.find('#quickview-select').append("<option value='" + v.id +
                                    "'>" + v.title + ' - ' + v.price + "</option>");
                            })
                            if (product.variants.length == 1 && product.variants[0].title.indexOf(
                                    'Default') != -1)
                            ...
                            if (product.variants.length == 1 && product.variants[0].title.indexOf(
                                ...
                                if (product.options.length == 1 && product.options[0].indexOf(
                                        'Tiêu đề') == -1)
                                    item.find('.selector-wrapper:eq(0)').prepend('<label>' + product
                                        .options[0] + '</label>');
                            ...
                            if (product.images.length == 0) {
                                item.find('.quickview-image').find('img').attr('alt', product.title)
                                    .attr('src',
                                        './hstatic.net/0/0/global/design/theme-default/no-image.png');
                            } else {
                                $('.quickview-slider').remove();
                                $('#quickview-sliderproduct').append(
                                    "<div class='quickview-slider' class='flexslider'>");
                                $('.quickview-slider').append("<ul class='owl-carousel'>");
                                $.each(product.images, function(i, v) {
                                    elem = $('<li class="product-thumb">').append(
                                        '<a href="javascript:void(0);" data-image=""><img /></a>'
                                    );
                                    elem.find('a').attr('data-image', Haravan.resizeImage(v,
                                        'large'));
                                    elem.find('img').attr('src', Haravan.resizeImage(v,
                                        'small'));
                                    item.find('.owl-carousel').append(elem);
                                });
                                item.find('.quickview-image img').attr('alt', product.title).attr('src',
                                ...
                                $('.quickview-slider img').imagesLoaded(function() {
                                    ...
                                    $('.quickview-slider .owl-carousel .owl-item').first()
                                        .children('.product-thumb').addClass('active');
                                });
        ...
        <section id="page_content" class="">
            <div id="pageContainer" class="clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-7 col-xs-7">
                                        ...
                                        <h1>
                                            <a href="{{ route('showindexdataproduct') }}">
                                                <img src="{{ asset('admin/shopping/theme.hstatic.net/1000177652/1000229231/14/logo.png?v=90') }}"
                                                    alt="Happylive" class="img-responsive logoimg" />
                                            </a>
                                        </h1>

                                        <h1 style="display:none">
                                            <a href="{{ route('showindexdataproduct') }}">AV78 Shop</a>
                                        </h1>
                                    </div>
                                    ...
                                    <div class="navholder">
                                        <nav id="subnav">
                                            <ul>
                                                ...
                                                <li><a class="reg" href="#" title="Đăng ký">ĐĂNG
                                                        KÝ</a></li>
                                                <li><a class="log" href="#" title="Đăng nhập">Đăng
                                                        nhập</a></li>
                                            </ul>
                                        </nav>
                        ...
                        <div class="row">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav clearfix">
                                    ...
                                    <li class="dropdown">
                                        <a href="{{ route('showallproduct') }}" title="Danh sách sản phẩm" class="">
                ...
                <div id="bannerWrapper" class="slider-default bannerslider">
                    <div class="hrv-banner-container">
                        <div class="hrvslider">
                            <ul class="slides">
                                <li>
                                    <a href="{{ route('showindexdataproduct') }}" class="hrv-url">
                                        <img class="img-responsive"
                                            src="{{ asset('admin/shopping/theme.hstatic.net/1000177652/1000229231/14/slideshow_1.jpg?v=90') }}"
                                            alt="Thời trang nam" />
                                    </a>
                                        ...
                                        <div class="container">
                                            <div class="hrv-caption-inner">
                                                <div class="hrv-banner-content slider-1">
                                                    ...
                                                    <a href="{{ route('showindexdataproduct') }}" class="hrv-url">Xem
                                                        ngay</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <a href="{{ route('showindexdataproduct') }}" class="hrv-url">
                                        <img class="img-responsive"
                                            src="{{ asset('admin/shopping/theme.hstatic.net/1000177652/1000229231/14/slideshow_2.jpg?v=90') }}"
                                            alt="" />
                                    </a>
                                        ...
                                        <div class="container">
                                            <div class="hrv-caption-inner">
                                                <div class="hrv-banner-content slider-3">
                                                    ...
                                                    <a href="/collections/cap-dong-ho-tinh-yeu" class="hrv-url">Xem
                                                        ngay</a>
                                                </div>
                                            </div>
                                        </div>
            ...
            <footer id="footer">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                <i class="fa fa-envelope-o"></i> <a
                                                    href="mailto:Suport@oxywatch.vn">Suport@oxywatch.vn</a>
                                            </li>
                ...
                <div class="footer-copyright">
                    <div class="container copyright">
                        <p>Copyright &copy; 2017 OxyWatch. <a target='_blank' href='https://www.haravan.com'>Powered
                                by Haravan</a>.</p>
            ...
            <!--Scroll to Top-->
            <div style="display:none" id="myCart" class="modal fade bs-example-modal-lg in" tabindex="-1"
                role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="false" style="display: block;">
                                ...
                                <table style="width:100%;" id="cart-table">
                                    <tbody>
                                        ...
                                        <tr class="line-item">
                                            ...
                                            <td class="item-title">
                                                <a href="/products/dong-ho-nam-tevise-1952-chay-co-cuc-chat">ĐỒNG HỒ
                                                    NAM TEVISE 1952 CHẠY CƠ CỰC CHẤT<br><span></span></a>
                                            </td>
                                            <td class="item-quantity"><input id="quantity1" name="updates[]"
                                                    min="1" type="number" value="3" class="">
                                            </td>
                                        ...
                                        <tr class="line-item">
                                            ...
                                            <td class="item-title">
                                                <a href="/products/dong-ho-nam-skmei-kim-xanh-duong">ĐỒNG HỒ NAM SKMEI
                                                    KIM XANH DƯƠNG<br><span></span></a>
                                            </td>
                                            <td class="item-quantity"><input id="quantity1" name="updates[]"
                                                    min="1" type="number" value="6" class="">
                                            </td>
                                ...
                                <div class="row" style="margin-top:10px;">
                                    ...
                                    <div class="col-lg-6 text-right">
                                        <div class="buttons btn-modal-cart">
                                            <button type="submit" class="button-default" id="checkout"
                                                name="checkout">
                                                Đặt hàng
