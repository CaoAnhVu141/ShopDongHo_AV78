...
<html lang="vi" xml:lang="vi" xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://opengraphprotocol.org/schema/"
...
<body>
    ...
    {{-- @include('shopping.components.header', ['category' => $category]) --}}
    <div class="content">
        @yield('content')
    </div>
    <div class="cb"></div>
    ...
    <div id="bttop">
        ...
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" viewBox="0 0 32.635 32.635" style="enable-background:new 0 0 32.635 32.635;"
            xml:space="preserve">
            <g>
    ...
    <div id="supRes" class="dn dbtablet-l">
        <a href="" title="Giỏ hàng" class="item">
            <span class="icon">
...
@yield('script')
<div class="zalo-chat-widget" data-oaid="" data-welcome-message="Rất vui khi được hỗ trợ bạn!" data-autopopup="0"
    data-width="300" data-height="300"> </div>
